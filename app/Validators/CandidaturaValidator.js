...
class CandidaturaValidator {
  ...
  get rules() {
    ...
    return {
      ...
      base_pais_formacao_id: `required`,
      base_provincia_formacao_id: `required`,
 
      base_nivel_formacao_id: `required`,

      edu_instituicao_id: `required`,
      edu_curso_id: `required`,


      ingresso: `required`,

       base_ano_frequencia_id : `required`,
  ...
  get messages() {
    return {
      ...
      'base_pais_formacao_id.required': 'Pais de formação Actual  é obrigatório.',
      'base_provincia_formacao_id.required': 'Provincia de Formação Actual  é obrigatório.',
      'edu_instituicao_id.required': ` Instituição é obrigatório `,
      ...
      'ingresso.required': 'Ano de Ingresso no Ensino superio é obrigatório.',
     ...
     'base_ano_frequencia_id.required': `Ano de Frequencia é obrigatório`
...
module.exports = CandidaturaValidator
