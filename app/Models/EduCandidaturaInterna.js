...
class EduCandidaturaInterna extends Model {
    ...
    motivo_exclusao() {
        return this.hasOne('App/Models/EduMotivoExclusoe', 'edu_motivo_exclusao_id', 'id')
    }
...
module.exports = EduCandidaturaInterna